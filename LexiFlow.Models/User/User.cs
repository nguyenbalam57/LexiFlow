...
namespace LexiFlow.Models.User
{
    ...
    public class User : SoftDeletableEntity, IActivatable
    {
        ...
        /// true = tài khoản đang hoạt động, false = bị vô hiệu hóa
        /// Mặc định là true
        /// </summary>
        public bool IsActive { get; set; } = true;

        /// <summary>
        /// Có bật xác thực 2 yếu tố (Two-Factor Authentication) không
        /// Tăng cường bảo mật bằng cách yêu cầu mã xác thực từ thiết bị di động
        /// Mặc định là false
        /// </summary>
        public bool IsMfaEnabled { get; set; } = false;

        /// <summary>
        /// Khóa bí mật cho xác thực 2 yếu tố
        /// Được sử dụng để tạo mã TOTP (Time-based One-Time Password)
        /// Tối đa 100 ký tự
        /// </summary>
        [StringLength(100)]
